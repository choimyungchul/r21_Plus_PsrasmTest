...
const clock_fro_config_t g_fro0Config_BOARD_BootClockRUN =
    {
        .targetFreq = 192000000,                  /* FRO0 TUNER output clock frequency: 250000000Hz */
...
void BOARD_BootClockRUN_InitClockModule(clock_module_t module)
{
    switch(module) {
        case kClockModule_FRO0:
            ...
            CLOCK_EnableFroClkFreqCloseLoop(FRO0, &g_fro0Config_BOARD_BootClockRUN, kCLOCK_FroDiv1OutEn | kCLOCK_FroDiv6OutEn);
        ...
        case kClockModule_CLK_ROOT_COMMON_RAM_CLK:
            ...
            /* Switch COMMON_RAM_CLK selector to COMMON_VDD2_BASE */
        ...
        case kClockModule_CLK_ROOT_MEDIA_VDDN_CLK:
            ...
            CLOCK_SetClkDiv(kCLOCK_DivMediaVddnClk, 4U);
...
void BOARD_BootClockRUN(void)
{
    ...
    SystemCoreClock = CLOCK_GetComputeMainClkFreq();
}
