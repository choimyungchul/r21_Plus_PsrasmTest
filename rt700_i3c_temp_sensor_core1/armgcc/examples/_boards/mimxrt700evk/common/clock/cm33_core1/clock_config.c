...
const clock_fro_config_t g_fro2Config_BOARD_BootClockRUN =
    {
        .targetFreq = 192000000,                  /* FRO2 TUNER output clock frequency: 198000000Hz */
...
void BOARD_BootClockRUN_InitClockModule(clock_module_t module)
{
    switch(module) {
        case kClockModule_FRO2:
            ...
            CLOCK_EnableFroClkFreqCloseLoop(FRO2, &g_fro2Config_BOARD_BootClockRUN, kCLOCK_FroDiv3OutEn);
...
void BOARD_BootClockRUN(void)
{
    ...
    SystemCoreClock = CLOCK_GetSenseMainClkFreq();
}
